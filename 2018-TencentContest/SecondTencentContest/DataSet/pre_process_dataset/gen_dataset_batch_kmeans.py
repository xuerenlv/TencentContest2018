...
def cluseter(formal, cl_num=None):
    if formal:
        ...
        if cl_num == 0:
            ...
            cluseter_num_name = ['cl200', 'cl400', 'cl800', 'cl1000']  # , 'cl7', 'cl8', 'cl9', 'cl10']
            cluseter_num_val = [200, 400, 800, 1000]
    else:
        dir_name = '../../DataSet/small_preliminary_contest_data/'
    ...
    file_name = dir_name+'finally_processed_data_all_user_clusters_'+'_'.join(cluseter_num_name)+'.csv'
