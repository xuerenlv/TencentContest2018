...
def inference(uid_p, lbs_p, age_p, carrier_p, consumptionability_p, education_p, gender_p, house_p,
    ...
    def gen_basic_relation_mat_user(name):
    ...
    def gen_basic_relation_mat_ad(name):
        with tf.variable_scope(name):
    ...
    with tf.variable_scope("OutAll"):
        ...
        # aid_v_ori_val = tf.expand_dims(tf.cast(tf.cast(aid_p, dtype=tf.bool), dtype=tf.float32), axis=1)
        # aid_v_ori = tf.matmul(aid_v_ori_val, aid_v_ori)
        ...
        #                       feature_conf_dict['kw1'][0] + feature_conf_dict['kw2'][0] + \
        #                       feature_conf_dict['kw3'][0] + feature_conf_dict['topic1'][0] + \
        #                       feature_conf_dict['topic2'][0] + feature_conf_dict['topic3'][0]
