...
if __name__ == '__main__':
    ...
    #                       'formal': False, 'epoch': 10, 'debug': True, 'o_dev_size': 2,
    #                       'creativeSize_pro': 'li_san', 'neg_size': 1, 'model': args.model, 'opt': args.opt,
    #                       'neg_start': args.neg_start, 'only_train': False}


    graph_hyper_params = {'batch_size': 32, 'l2_reg_alpha':0.0, 'learn_rate': args.lr, 'show_peroid': args.shp,
                          'formal': True, 'epoch': 3, 'debug': False, 'o_dev_size': 10000,
