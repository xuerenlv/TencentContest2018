...
def predict(model_path, formal):
    ...
    feature_conf_dict_file = os.path.join(model_path, 'feature_conf_dict.pic')
    ...
    if formal:
        graph_hyper_params['batch_size'] = 256
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            pred_val = graph.get_operation_by_name("OutAll/pred").outputs[0]
            ...
            def get_fed_dict(formal, uid_map_row, aid_map_row, pda, spv, feature_conf_dict):
                if formal:
                ...
                # print 122
                interest1_li = spv(b_u_d['interest1'], interest='interest1', feature_config=feature_conf_dict)
                fed_dict[interest1_index_p], fed_dict[interest1_val_p] = interest1_li[0], interest1_li[1]
                interest2_li = spv(b_u_d['interest2'], interest='interest2', feature_config=feature_conf_dict)
                fed_dict[interest2_index_p], fed_dict[interest2_val_p] = interest2_li[0], interest2_li[1]
                interest3_li = spv(b_u_d['interest3'], interest='interest3', feature_config=feature_conf_dict)
                fed_dict[interest3_index_p], fed_dict[interest3_val_p] = interest3_li[0], interest3_li[1]
                interest4_li = spv(b_u_d['interest4'], interest='interest4', feature_config=feature_conf_dict)
                fed_dict[interest4_index_p], fed_dict[interest4_val_p] = interest4_li[0], interest4_li[1]
                interest5_li = spv(b_u_d['interest5'], interest='interest5', feature_config=feature_conf_dict)
            ...
            for index in tqdm(range(e_b_s)):
                ...
                fed_dict = get_fed_dict(formal, uid_map_row, aid_map_row, b_predict_data, split_vector_data, feature_conf_dict)
...
if __name__ == '__main__':
    ...
    # predict('/Users/Xuehj/Desktop/TencentContest/CodeBase/stage5_dmf_tencent/checkpoints/dmf_tencent/2018-05-05-10-30-31', False)
