...
def parse():
    ...
    args.add_argument('--mtyp', type=int, default=2, help='mtyp') # model type, 1:deep, 2:wide, 3:joint， 4: pre_traing
    return args
...
if __name__ == '__main__':
    ...
    graph_hyper_params = {'batch_size': 32, 'l2_reg_alpha': args.l2, 'learn_rate': args.lr, 'show_peroid': 10,
