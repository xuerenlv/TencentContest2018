...
def inference(uid_p, lbs_p, age_p, carrier_p, consumptionability_p, education_p, gender_p, house_p,
    ...
    creativeid_p,adcategoryid_p, productid_p, producttype_p, creativesize_p, true_label, feature_conf_dict, graph_hyper_params,
              train_p, dropout_p, user_feature_start, ad_feature_start, user_input_len, user_all_len, ad_all_len, control_train_v = False):
    ...
    with tf.variable_scope("OutAll"):
        ...
        LBS_emb = tf.get_variable("LBS_emb", shape=(feature_conf_dict['LBS'], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        age_emb = tf.get_variable("age_emb", shape=(feature_conf_dict['age'], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        carrier_emb = tf.get_variable("carrier_emb", shape=(feature_conf_dict['carrier'], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        consumptionAbility_emb = tf.get_variable("consumptionAbility_emb", shape=(feature_conf_dict['consumptionAbility'], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        education_emb = tf.get_variable("education_emb", shape=(feature_conf_dict['education'], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        gender_emb = tf.get_variable("gender_emb", shape=(feature_conf_dict['gender'], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        house_emb = tf.get_variable("house_emb", shape=(feature_conf_dict['house'], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)

        os_emb = tf.get_variable("os_emb", shape=(feature_conf_dict['os'], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        ct_emb = tf.get_variable("ct_emb", shape=(feature_conf_dict['ct'], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        marriageStatus_emb = tf.get_variable("marriageStatus_emb", shape=(feature_conf_dict['marriageStatus'], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)

        appIdAction_emb = tf.get_variable("appIdAction_emb", shape=(feature_conf_dict['appIdAction'][0], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        appIdInstall_emb = tf.get_variable("appIdInstall_emb", shape=(feature_conf_dict['appIdInstall'][0], low_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        interest1_emb = tf.get_variable("interest1_emb", shape=(feature_conf_dict['interest1'][0], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        interest2_emb = tf.get_variable("interest2_emb", shape=(feature_conf_dict['interest2'][0], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        interest3_emb = tf.get_variable("interest3_emb", shape=(feature_conf_dict['interest3'][0], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        interest4_emb = tf.get_variable("interest4_emb", shape=(feature_conf_dict['interest4'][0], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32,regularizer=regularizer, trainable=control_train_v)
        interest5_emb = tf.get_variable("interest5_emb", shape=(feature_conf_dict['interest5'][0], emb_size),initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)

        kw1_emb = tf.get_variable("kw1_emb", shape=(feature_conf_dict['kw1'][0], low_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        kw2_emb = tf.get_variable("kw2_emb", shape=(feature_conf_dict['kw2'][0], low_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        kw3_emb = tf.get_variable("kw3_emb", shape=(feature_conf_dict['kw3'][0], low_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)

        topic1_emb = tf.get_variable("topic1_emb", shape=(feature_conf_dict['topic1'][0], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        topic2_emb = tf.get_variable("topic2_emb", shape=(feature_conf_dict['topic2'][0], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        topic3_emb = tf.get_variable("topic3_emb", shape=(feature_conf_dict['topic3'][0], emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        ...
        advertiserId_emb = tf.get_variable("advertiserId_emb", shape=(feature_conf_dict['advertiserId'], ad_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        campaignId_emb = tf.get_variable("campaignId_emb", shape=(feature_conf_dict['campaignId'], ad_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        creativeId_emb = tf.get_variable("creativeId_emb", shape=(feature_conf_dict['creativeId'], ad_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        adCategoryId_emb = tf.get_variable("adCategoryId_emb", shape=(feature_conf_dict['adCategoryId'], ad_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        productId_emb = tf.get_variable("productId_emb", shape=(feature_conf_dict['productId'], ad_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        productType_emb = tf.get_variable("productType_emb", shape=(feature_conf_dict['productType'], ad_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        ...
        LBS_emb_bias = tf.get_variable("LBS_emb_bias", shape=(feature_conf_dict['LBS'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32,regularizer=regularizer, trainable=control_train_v)
        age_emb_bias = tf.get_variable("age_emb_bias", shape=(feature_conf_dict['age'], 1),initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        carrier_emb_bias = tf.get_variable("carrier_emb_bias", shape=(feature_conf_dict['carrier'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        consumptionAbility_emb_bias = tf.get_variable("consumptionAbility_emb_bias", shape=(feature_conf_dict['consumptionAbility'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        education_emb_bias = tf.get_variable("education_emb_bias", shape=(feature_conf_dict['education'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        gender_emb_bias = tf.get_variable("gender_emb_bias", shape=(feature_conf_dict['gender'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        house_emb_bias = tf.get_variable("house_emb_bias", shape=(feature_conf_dict['house'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        os_emb_bias = tf.get_variable("os_emb_bias", shape=(feature_conf_dict['os'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        ct_emb_bias = tf.get_variable("ct_emb_bias", shape=(feature_conf_dict['ct'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        marriageStatus_emb_bias = tf.get_variable("marriageStatus_emb_bias", shape=(feature_conf_dict['marriageStatus'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)

        appIdAction_emb_bias = tf.get_variable("appIdAction_emb_bias", shape=(feature_conf_dict['appIdAction'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        appIdInstall_emb_bias = tf.get_variable("appIdInstall_emb_bias", shape=(feature_conf_dict['appIdInstall'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        interest1_emb_bias = tf.get_variable("interest1_emb_bias", shape=(feature_conf_dict['interest1'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        interest2_emb_bias = tf.get_variable("interest2_emb_bias", shape=(feature_conf_dict['interest2'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        interest3_emb_bias = tf.get_variable("interest3_emb_bias", shape=(feature_conf_dict['interest3'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        interest4_emb_bias = tf.get_variable("interest4_emb_bias", shape=(feature_conf_dict['interest4'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        interest5_emb_bias = tf.get_variable("interest5_emb_bias", shape=(feature_conf_dict['interest5'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        kw1_emb_bias = tf.get_variable("kw1_emb_bias", shape=(feature_conf_dict['kw1'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        kw2_emb_bias = tf.get_variable("kw2_emb_bias", shape=(feature_conf_dict['kw2'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        kw3_emb_bias = tf.get_variable("kw3_emb_bias", shape=(feature_conf_dict['kw3'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        topic1_emb_bias = tf.get_variable("topic1_emb_bias", shape=(feature_conf_dict['topic1'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        topic2_emb_bias = tf.get_variable("topic2_emb_bias", shape=(feature_conf_dict['topic2'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        topic3_emb_bias = tf.get_variable("topic3_emb_bias", shape=(feature_conf_dict['topic3'][0], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        ...
        advertiserId_emb_bias = tf.get_variable("advertiserId_emb_bias", shape=(feature_conf_dict['advertiserId'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        campaignId_emb_bias = tf.get_variable("campaignId_emb_bias", shape=(feature_conf_dict['campaignId'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        creativeId_emb_bias = tf.get_variable("creativeId_emb_bias", shape=(feature_conf_dict['creativeId'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        adCategoryId_emb_bias = tf.get_variable("adCategoryId_emb_bias", shape=(feature_conf_dict['adCategoryId'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        productId_emb_bias = tf.get_variable("productId_emb_bias", shape=(feature_conf_dict['productId'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        productType_emb_bias = tf.get_variable("productType_emb_bias", shape=(feature_conf_dict['productType'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)

        # for cross module
        cross_module_emb_user = tf.get_variable("cross_len_for_emb_user", shape=(user_all_len, cross_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        cross_module_emb_ad = tf.get_variable("cross_len_for_emb_ad", shape=(ad_all_len, cross_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        ...
        user_index_features_emb = tf.get_variable("user_index_features_emb", shape=[23, cross_emb_size], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        ...
        ad_index_features_emb = tf.get_variable("ad_index_features_emb", shape=[7, cross_emb_size], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        ...
        cross_b1 = tf.get_variable("cross_b1", shape=[cross_emb_size*2], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        cross_net1 = tf.nn.relu(tf.reshape(tf.matmul(all_cross_module_val, cross_emb_ori), [-1, cross_emb_size*2]) + cross_b1)
...
# cross net1
        ...
        if graph_hyper_params['creativeSize_pro'] == 'min_max':
            ...
            creativesize_emb = tf.get_variable("creativesize_emb", shape=(feature_conf_dict['creativeSize'], ad_emb_size), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
            creativesize_emb_bias = tf.get_variable("creativesize_emb_bias", shape=(feature_conf_dict['creativeSize'], 1), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
        ...
        if graph_hyper_params['model'] == 'dmf':
            ...
            u_b1 = tf.get_variable("u_b1", shape=[user_vector_size], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
            ...
            u_w2 = tf.get_variable("u_w2", shape=(user_vector_size, 500), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
            u_b2 = tf.get_variable("u_b2", shape=[500], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
            ...
            v_b1 = tf.get_variable("v_b1", shape=[ad_vector_size], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
            ...
            v_w2 = tf.get_variable("v_w2", shape=(ad_vector_size, 500), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
            v_b2 = tf.get_variable("v_b2", shape=[500], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
            ...
            if graph_hyper_params['use_kernal']:
                ...
                wf_res1 = tf.get_variable("wf_res1", shape=(1000, 1000), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
                bf_res1 = tf.get_variable("bf_res1", shape=[1000], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
                final_vec_wf_pre_res1 = tf.matmul(final_vec, wf_res1) + bf_res1
                final_vec_wf_res1 = tf.nn.relu(final_vec_wf_pre_res1)

                wf_res2 = tf.get_variable("wf_res2", shape=(1000, 1000), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
                bf_res2 = tf.get_variable("bf_res2", shape=[1000], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
                ...
                wf_res3 = tf.get_variable("wf_res3", shape=(1000, 1000), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32,regularizer=regularizer, trainable=control_train_v)
                bf_res3 = tf.get_variable("bf_res3", shape=[1000], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
                final_vec_wf_pre_res3 = tf.matmul(final_vec, wf_res3) + bf_res3
                final_vec_wf_res3 = tf.nn.relu(final_vec_wf_pre_res3)

                wf_res4 = tf.get_variable("wf_res4", shape=(1000, 1000), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
                bf_res4 = tf.get_variable("bf_res4", shape=[1000], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
                ...
                wf_res5 = tf.get_variable("wf_res5", shape=(1000, 1000), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
                bf_res5 = tf.get_variable("bf_res5", shape=[1000], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
                final_vec_wf_pre_res5 = tf.matmul(final_vec, wf_res5) + bf_res5
                final_vec_wf_res5 = tf.nn.relu(final_vec_wf_pre_res5)

                wf_res6 = tf.get_variable("wf_res6", shape=(1000, 1000), initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
                bf_res6 = tf.get_variable("bf_res6", shape=[1000], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
                ...
                wf1 = tf.get_variable("wf1", shape=(1000, 500),initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
                bf1 = tf.get_variable("bf1", shape=[500], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32, regularizer=regularizer, trainable=control_train_v)
...
# wide_pred
                ...
                with tf.name_scope("final"):
                    if graph_hyper_params['mtyp'] == 1:
                        ...
                        # wf_pret = tf.get_variable("pre_train_wf", shape=(cross_emb_size*2 + 500, 2), initializer=tf.contrib.layers.xavier_initializer(),dtype=tf.float32, regularizer=regularizer)
                        # bf_pret = tf.get_variable("pre_train_bf", shape=[2], initializer=tf.contrib.layers.xavier_initializer(),dtype=tf.float32, regularizer=regularizer)

                        wf_pret = tf.concat([wf2, wwf], axis=0)
                        bf_pret = ( bf2 + wbf ) / 2.0
                        final_vec_wf_2 = tf.matmul(tf.concat([final_vec_1, cross_net1], axis=-1), wf_pret) + bf_pret
            ...
            if graph_hyper_params['mtyp'] == 1:
                ...
                gmf_loss = tf.reduce_mean(-true_label * tf.log(pre_pred_val + 1e-6) - (1.0 - true_label) * tf.log(1.0 - pre_pred_val + 1e-6))
            else:
                print 'wrong model type !'
